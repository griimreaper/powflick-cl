            ...
            <CategoryMenuItem
              ...
              render={
                item.products?.length ? (
                  <Box sx={{ display: 'flex', flexDirection: 'column', bgcolor:'white', marginLeft: 2, boxShadow: '2', borderRadius: 2, padding: 2, maxHeight: 350, overflowY: 'scroll' }} >
