        ...
        {selectedOption === 0 &&
          <Box display={'flex'} flexDirection={{ xs: 'column', md: 'row' }} width={'100%'} height={'100%'} alignItems={'center'}>
            <Box width={{ xs: '100%', md: '50%' }} p={2} display={'flex'} flexDirection={'column'} alignItems={'start'} justifyContent={'space-around'} gap={2}>
              ...
              <Typography variant="body1" paragraph fontWeight={500} fontSize={{ xs: '2.5vw', md: '1.2vw' }}>
                <Typography component="span" fontWeight="bold" color="primary.main" fontSize={{ xs: '2.5vw', md: '1.2vw' }}>POW FLICK</Typography> is a premium sportswear brand specializing in custom team uniforms for football, basketball, and more.
              </Typography>
              ...
              <Box sx={{ mb: 1 }}>
                <Typography variant="body1" fontWeight={500} fontSize={{ xs: '2.5vw', md: '1.2vw' }}>
                  -
                  <Typography component="span" fontWeight="bold" color="primary.main" fontSize={{ xs: '2.5vw', md: '1.2vw' }}>
        ...
        {selectedOption === 2 &&
          <Grid container spacing={4} p={4}>
            ...
            <Grid item xs={12} md={6}>
              <Box display={'flex'} flexDirection={'column'} alignItems={'start'} justifyContent={'center'} height={'100%'} gap={2} >
                <Typography variant="h6" color="primary.main" fontWeight={800} mb={2}>
                ...
                <Typography variant="subtitle1" color="primary.main" fontWeight={800}>- Production & Processing Time</Typography>
                <Typography fontWeight={500}>All custom uniforms are made-to-order. Our standard production timeline is
                  3-4 weeks, depending on the order size and complexity.</Typography>

                <Typography variant="subtitle1" color="primary.main" fontWeight={800}>- International Express Delivery</Typography>
                <Typography fontWeight={500}>We ship worldwide via trusted logistics partners (FedEx, DHL, etc.), ensuring
                  safe and timely delivery.</Typography>

                <Typography variant="subtitle1" color="primary.main" fontWeight={800}>- Estimated Shipping Time</Typography>
                <Typography fontWeight={500}>
            ...
            <Grid item xs={12} md={6}>
              <Box display={'flex'} flexDirection={'column'} alignItems={'start'} justifyContent={'space-between'} height={'100%'} gap={2}>
                <Box display={'flex'} flexDirection={'column'} gap={2}>
                  <Typography variant="subtitle1" color="primary.main" fontWeight={800}>- Tracking</Typography>
                  <Typography fontWeight={500}>
