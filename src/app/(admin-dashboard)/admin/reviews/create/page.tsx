...
import CreateReviewPageView from "pages-sections/vendor-dashboard/products/page-view/review-create";

export const metadata: Metadata = {
  title: "Review Create - Pow Flick",
