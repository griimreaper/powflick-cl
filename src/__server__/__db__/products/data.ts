...
import SportZoneReactDatabase from "data/SportZone-react-database";
...
const dbProducts = [...SportZoneReactDatabase, ...products];

// all used products in the SportZone template
const productList = [
  ...dbProducts,
  ...fashion1,
  ...fashion2,
